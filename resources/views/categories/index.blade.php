...
@section('content')
  ...
  <!-- clients -->
      ...
      <div class="box">
        ...
        <div class="box-body">
        <a href = "{{url(route('categories.create'))}}" class="btn btn-primary"><i class= "fa fa-plus"></i>New Categories</a>
        <br>
...
<div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <tr role="row" class="odd">
                  ...
                  <td>{{$recorde->name}}</td>
                  <td class="text-center"><a href = "{{url(route('categories.edit' , $recorde->id))}}"  class="btn btn-success"><i class="fa fa-edit"></i></a></td>
                  <td class="text-center"> 
                  {!! Form::open([
                     
                     'action' => ['categoryController@destroy',$recorde->id],
                     'method' => 'delete'
                     ]) !!}
