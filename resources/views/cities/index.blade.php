...
<div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending"> Government
                </th>
            ...
            <tr role="row" class="odd">
                  ...
                  <td>{{$recorde->name}}</td>
                  <td>{{$recorde->Government->name}}</td>
                  <td class="text-center"><a href = "{{url(route('cities.edit' , $recorde->id))}}"  class="btn btn-success"><i class="fa fa-edit"></i></a></td>
                  <td class="text-center"> 
                  {!! Form::open([
                     
                     "action" => ['CityController@destroy' , $recorde->id],
                     'method' => 'delete'
                     ])!!}
